...
const features: Feature[] = [
  {
    id: "chat",
    title: "AI Chat",
    description: "GPT-5 Nano powered AI assistant with markdown support",
    icon: "💬",
    href: "/chat",
  },
  {
  ...
  },
  {
    id: "vision",
    title: "Vision Lab",
    description: "Image analysis with GPT-5 Nano Vision",
    icon: "🖼️",
    href: "/vision",
  },
  {
...
const techStack = [
  "Next.js 16", "React 19", "FastAPI", "OpenAI GPT-5 Nano",
    ...
    <main className="min-h-screen bg-[#050505] text-white relative overflow-hidden">
      ...
      <section className="relative pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            A full-stack AI platform featuring <span className="text-[#39ff14]">GPT-5 Nano</span>,
