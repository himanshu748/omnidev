        ...
        <main className="min-h-screen bg-[#050505] text-white">
            ...
            <div className="max-w-6xl mx-auto px-6 py-8">
                ...
                >
                    ...
                    <p className="text-gray-400">Upload an image and let GPT-5 Nano Vision analyze it</p>
                </motion.div>
                ...
                >
                    <h2 className="text-xl font-semibold mb-6 text-center text-[#39ff14]">Powered by GPT-5 Nano Vision</h2>
